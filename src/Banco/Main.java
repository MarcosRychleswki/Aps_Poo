...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (conta == 1) {
			...
			System.out.println("Saldo " + contaCorrente.getSaldo());
			// System.out.println("Voce fez um deposito seu saldo agr e: " +
...
//			System.out.println("Saldo " + contaEspecial.getSaldo());
//			System.out.println("Saldo " + contaEspecial.getSaldo());
//			System.out.println("Sua lista de contas especial agr ");
			g.adicionarConta(new ContaEspecial(3, "thiago", 503173, 100.00, "Lucas"));
			//g.buscarContasEspeciais(g.gerenciarContaEspecial.get(0).limite);
            System.out.println(g.gerenciarContaEspecial.get(0).usandoLimite());
		}

		if (conta == 4) {
			GerenciarConta g = new GerenciarConta();
			System.out.println("Sua lista de contas agr ");
			g.adicionarConta(new ContaCorrente(1, "Marcos", 503173, 0.00));
			g.adicionarConta(new ContaPoupanca(2, "Lais", 5031));
			g.adicionarConta(new ContaEspecial(3, "thiago", 503173, 100.00, "Lucas"));
			System.out.println("\n ");
			System.out.println("Voce removeu ");
			g.removerConta(3);
			System.out.println("\n ");
			g.removerConta(2);
			System.out.println("\n ");
